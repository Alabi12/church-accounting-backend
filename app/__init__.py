# app/__init__.py - Complete working version
...
def create_app(config_name='development'):
    ...
    if config_name == 'production':
        print("Rate limiting is disabled for all environments")
    else:
        print("Rate limiting completely disabled for development")
    ...
    with app.app_context():
        ...
        if app.debug:
            try:
                ...
                print(f"Could not register connection pool listeners: {e}")
